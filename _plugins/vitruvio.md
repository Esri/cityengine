...
examples:
  ...
  - title: Boston
    ...
    files:
      - title: Boston Example
        link: https://github.com/Esri/vitruvio/releases/download/v2.1/Vitruvio_Boston_UE54.zip
  ...
  - title: Paris
    ...
    files:
      - title: Paris Example
        link: https://github.com/Esri/vitruvio/releases/download/v2.1/Vitruvio_Paris_UE54.zip
  ...
  - title: New York
    ...
    files:
      - title: New York Example
        link: https://github.com/Esri/vitruvio/releases/download/v2.1/Vitruvio_NewYork_UE54.zip
  ...
  - title: Medieval City
    ...
    files:
      - title: Medieval City Example
        link: https://github.com/Esri/vitruvio/releases/download/v2.1/Vitruvio_MedievalCity_UE54.zip
  ...
  - title: NYC 2259
    ...
    files:
      - title: NYC 2259 Example
        link: https://github.com/Esri/vitruvio/releases/download/v2.1/Vitruvio_NYC2259_UE54.zip
