...
examples:
  - title: New York
    ...
    files:
      - title: New York Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_NewYork.zip
  ...
  - title: Zurich
    ...
    files:
      - title: Zurich Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_Zurich.zip
  ...
  - title: Boston Asset Replacements
    ...
    files:
      - title: Boston Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_Boston.zip
  ...
  - title: Paris
    ...
    files:
      - title: Paris Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_Paris.zip
  ...
  - title: Medieval City
    ...
    files:
      - title: Medieval City Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_MedievalCity.zip
  ...
  - title: NYC 2259
    ...
    files:
      - title: NYC 2259 Example
        link: https://github.com/Esri/cityengine_for_unreal/releases/download/v2.4/CE_for_UE56_NYC2259.zip
